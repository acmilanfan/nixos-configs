...

{
  ...
  home.file.".config/kanata/kanata-default.kbd".source = lib.mkForce ../../dotfiles/kanata/kanata-default.kbd;  home.file.".config/kanata/kanata-angle.kbd".source = lib.mkForce ../../dotfiles/kanata/kanata-angle.kbd;
